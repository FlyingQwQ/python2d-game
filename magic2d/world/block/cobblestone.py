...
class CobbleStone(pygame.sprite.Sprite, magic2d.world.block.basicblock.BasicBlock):
    ...
    def __init__(self):
        super().__init__()
        self.imgfile = ImageHandleTools.scale(magic2d.resouces.cobblestone, 30, 30)
